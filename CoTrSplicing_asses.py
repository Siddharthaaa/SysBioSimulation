...
#s = bs.get_exmpl_sim("CoTrSplicing")
#s.set_runtime(80000)
#pars = {"elong_v": np.linspace(10,120,21), ("u1_2_br","u2_1_br"): np.linspace(0.005,0.1, 21)}
#res = s.plot_par_var_2d(pars, None, s.get_psi_mean, ignore_fraction=0.8)


s = bs.get_exmpl_sim("CoTrSplicing")
s.set_runtime(200000)
...
ax.set_xlabel("PSI")
ax.set_ylabel("$\Delta STD(PSI)$")
ax.scatter(psi_means, np.subtract(psi_stds, psi_std_basic_model))
fig.suptitle("Variation of v2")
